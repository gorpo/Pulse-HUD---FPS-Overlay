...
internal static class Launcher
{
    ...
    private static int Main(string[] args)
    {
        try
        {
            ...
            {
                MessageBox.Show("Script nao encontrado:\n" + script, "Pulse HUD - FPS Overlay", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return 2;
            }
        ...
        {
            MessageBox.Show(ex.Message, "Pulse HUD - FPS Overlay", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return 1;
        }
    }
